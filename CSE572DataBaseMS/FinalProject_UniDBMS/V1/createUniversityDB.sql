...
CREATE TABLE StudentModule (
                Module_Code  CHAR(5),
                Matriculation_Number  CHAR(9),
                Performance  CHAR(1),
                CONSTRAINTS StudentModule_PK PRIMARY KEY (Module_Code, Matriculation_Number)
);
...
CREATE TABLE Students (
                ...
                CONSTRAINTS Students_PK PRIMARY KEY (Matriculation_Number)
);
...
/*******************************************  
Project Option: University Database 
Purpose: ALTERING TABLE ADDING CONTRAINTS
Author: Shutu Li 006704029
*******************************************/
...
ALTER TABLE StudentModule
     ADD CONSTRAINTS StudentModule_Matri_No_FK FOREIGN KEY (Matriculation_Number) 
REFERENCES Students(Matriculation_Number)
                ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE NextOfKin 
	ADD CONSTRAINTS NextOfKin_Student_Name_FK FOREIGN KEY (Student_Name) 
REFERENCES Students(Student_Name)

ALTER TABLE NextOfKin 
    ADD CONSTRAINTS NextOfKin_Matri_No_FK FOREIGN KEY (Matriculation_Number) 
REFERENCES Students(Matriculation_Number)
   ON DELETE CASCADE DEFERRABLE INITIALLY IMMEDIATE;
